...
- Лотов после дедупликации: `1556`
- Удалено дублей: `65`
- Источники core-лотов: `Сбербанк-АСТ` - `940`, `Росэлторг` - `616`
- Лотов с раскрытой ценой: `382`, покрытие ценой: `24.55%`
- Товарных строк: `3331`, из них с unit price: `2310`
...
- `configs/entity_scope.csv` — перечень юридических лиц группы Сбер.
...
- `ЕИС` даёт лучший официальный контур идентификации.
